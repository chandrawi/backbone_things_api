 ...
 * @returns {Promise<DataSchema[]>} data schema: device_id, model_id, timestamp, data, tag
 */
export async function list_data_by_earlier(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    ...
    return client.listDataByEarlier(dataEarlier, metadata(server))
        .then(response => get_data_schema_vec(response.toObject().resultsList));
}
 ...
 * @returns {Promise<DataSchema[]>} data schema: device_id, model_id, timestamp, data, tag
 */
export async function list_data_by_later(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    ...
    return client.listDataByLater(dataLater, metadata(server))
        .then(response => get_data_schema_vec(response.toObject().resultsList));
}
 ...
 * @returns {Promise<DataSchema[]>} data schema: device_id, model_id, timestamp, data, tag
 */
export async function list_data_group_by_earlier(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    ...
    return client.listDataGroupByEarlier(dataGroupEarlier, metadata(server))
        .then(response => get_data_schema_vec(response.toObject().resultsList));
}
 ...
 * @returns {Promise<DataSchema[]>} data schema: device_id, model_id, timestamp, data, tag
 */
export async function list_data_group_by_later(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    ...
    return client.listDataGroupByLater(dataGroupLater, metadata(server))
        .then(response => get_data_schema_vec(response.toObject().resultsList));
}
 ...
 * @returns {Promise<DataSetSchema[]>} data set schema: set_id, timestamp, data, tag
 */
export async function list_data_set_by_earlier(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    ...
    return client.listDataSetByEarlier(dataSetLater, metadata(server))
        .then(response => get_data_set_schema_vec(response.toObject().resultsList));
}
 ...
 * @returns {Promise<DataSetSchema[]>} data set schema: set_id, timestamp, data, tag
 */
export async function list_data_set_by_later(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    ...
    return client.listDataSetByLater(dataSetLater, metadata(server))
        .then(response => get_data_set_schema_vec(response.toObject().resultsList));
}
 ...
 * @returns {Promise<Date[]>} data timestamp
 */
export async function list_data_timestamp_by_earlier(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    const dataEarlier = new pb_data.DataEarlier();
    dataEarlier.setDeviceId(uuid_hex_to_base64(request.device_id));
    dataEarlier.setModelId(uuid_hex_to_base64(request.model_id));
    dataEarlier.setEarlier(request.earlier.valueOf() * 1000);
    dataEarlier.setTag(request.tag);
    return client.listDataTimestampByEarlier(dataEarlier, metadata(server))
 ...
 * @returns {Promise<Date[]>} data timestamp
 */
export async function list_data_timestamp_by_later(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    const dataLater = new pb_data.DataLater();
    dataLater.setDeviceId(uuid_hex_to_base64(request.device_id));
    dataLater.setModelId(uuid_hex_to_base64(request.model_id));
    dataLater.setLater(request.later.valueOf() * 1000);
    dataLater.setTag(request.tag);
    return client.listDataTimestampByLater(dataLater, metadata(server))
        .then(response => response.toObject().timestampsList.map((v) => new Date(v / 1000)));
}
 ...
 * @returns {Promise<Date[]>} data timestamp
 */
export async function list_data_group_timestamp_by_earlier(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    const dataGroupEarlier = new pb_data.DataGroupEarlier();
    dataGroupEarlier.setDeviceIdsList(request.device_ids.map((id) => uuid_hex_to_base64(id)));
    dataGroupEarlier.setModelIdsList(request.model_ids.map((id) => uuid_hex_to_base64(id)));
    dataGroupEarlier.setEarlier(request.earlier.valueOf() * 1000);
    dataGroupEarlier.setTag(request.tag);
    return client.listDataGroupTimestampByEarlier(dataGroupEarlier, metadata(server))
        .then(response => response.toObject().timestampsList.map((v) => new Date(v / 1000)));
}
 ...
 * @returns {Promise<Date[]>} data timestamp
 */
export async function list_data_group_timestamp_by_later(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    const dataGroupLater = new pb_data.DataGroupLater();
    dataGroupLater.setDeviceIdsList(request.device_ids.map((id) => uuid_hex_to_base64(id)));
    dataGroupLater.setModelIdsList(request.model_ids.map((id) => uuid_hex_to_base64(id)));
    dataGroupLater.setLater(request.later.valueOf() * 1000);
    dataGroupLater.setTag(request.tag);
    return client.listDataGroupTimestampByLater(dataGroupLater, metadata(server))
        .then(response => response.toObject().timestampsList.map((v) => new Date(v / 1000)));
}
 ...
 * @returns {Promise<number>} data count
 */
export async function count_data_by_earlier(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    const dataEarlier = new pb_data.DataEarlier();
    dataEarlier.setDeviceId(uuid_hex_to_base64(request.device_id));
    dataEarlier.setModelId(uuid_hex_to_base64(request.model_id));
    dataEarlier.setEarlier(request.earlier.valueOf() * 1000);
    dataEarlier.setTag(request.tag);
    return client.countDataByEarlier(dataEarlier, metadata(server))
        .then(response => response.toObject().count);
}
 ...
 * @returns {Promise<number>} data count
 */
export async function count_data_by_later(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    const dataLater = new pb_data.DataLater();
    dataLater.setDeviceId(uuid_hex_to_base64(request.device_id));
    dataLater.setModelId(uuid_hex_to_base64(request.model_id));
    dataLater.setLater(request.later.valueOf() * 1000);
    dataLater.setTag(request.tag);
    return client.countDataByLater(dataLater, metadata(server))
        .then(response => response.toObject().count);
}
 ...
 * @returns {Promise<number>} data count
 */
export async function count_data_group_by_earlier(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    const dataGroupEarlier = new pb_data.DataGroupEarlier();
    dataGroupEarlier.setDeviceIdsList(request.device_ids.map((id) => uuid_hex_to_base64(id)));
    dataGroupEarlier.setModelIdsList(request.model_ids.map((id) => uuid_hex_to_base64(id)));
    dataGroupEarlier.setEarlier(request.earlier.valueOf() * 1000);
    dataGroupEarlier.setTag(request.tag);
    return client.countDataGroupByEarlier(dataGroupEarlier, metadata(server))
        .then(response => response.toObject().count);
}
 ...
 * @returns {Promise<number>} data count
 */
export async function count_data_group_by_later(server, request) {
    const client = new pb_data.DataServicePromiseClient(server.address, null, null);
    const dataGroupLater = new pb_data.DataGroupLater();
    dataGroupLater.setDeviceIdsList(request.device_ids.map((id) => uuid_hex_to_base64(id)));
    dataGroupLater.setModelIdsList(request.model_ids.map((id) => uuid_hex_to_base64(id)));
    dataGroupLater.setLater(request.later.valueOf() * 1000);
    dataGroupLater.setTag(request.tag);
    return client.countDataGroupByLater(dataGroupLater, metadata(server))
        .then(response => response.toObject().count);
}
