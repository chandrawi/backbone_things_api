...
# source: bbthings_grpc/proto/auth/user.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'bbthings_grpc/proto/auth/user.proto'
)
