...
mod tests {
    use uuid::Uuid;
    use chrono::DateTime;
    use bbthings_grpc_client::Auth;
    use bbthings_grpc_client::ProfileMode::*;
    use bbthings_grpc_client::{DataType::*, DataValue::*};
    use bbthings_grpc_client::utility;
    ...
    async fn test_auth()
    {
        ...
        assert_eq!(auth_token.expired, expire1);
        assert_eq!(auth_token.ip, [192, 168, 0, 1]);
        assert_eq!(access_token.expired, expire2);
        ...
        assert_eq!(new_access_token.expired, expire3);
        assert_eq!(new_auth_token.expired, expire3);
